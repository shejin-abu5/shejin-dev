...
export function useReveal(
  ...
  // One reveal for everyone. This went through two earlier shapes — bailing
  // outright under `prefers-reduced-motion: reduce`, then a fade-only path with
  // no rise and no stagger — and both left the site reading differently
  // depending on an OS switch. See BALL_QUERY in composables/useScrollBall.ts
  // for why that gating came out altogether.
